            ...
            <div class="page_wrap">
                ...
                <form action="${path}/UpdateDeliveryPostPro.do" class="frm" method="post">
                    <table class="tb1">
                        ...
                        <tr>
                            <th>배송회사</th>
                            <td colspan="2"><input type="text" name="pcom" id="pcom" class="indata" required></td>
                        </tr>
                        <tr>
                            <th>기사번호</th>
                            <td colspan="2"><input type="text" name="ptel" id="ptel" class="indata" required></td>
                        </tr>
                        <tr>
                            <th>운송번호</th>
                            <td colspan="2"><input type="text" name="bcode" id="bcode" class="indata" required></td>
                        </tr>
                        <tr>
                            <th>배송날짜</th>
                            <td colspan="2"><input type="text" name="rdate" id="rdate" class="indata" required maxlength="13"></td>
                        </tr>
                        <tr>
                            <td colspan="2">
