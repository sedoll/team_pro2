...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/board/boardList.jsp">배송시작</a>
                &gt; <a href="/board/addBoard.jsp">배송시작</a></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">배송시작</h2>
                        ...
                        <td>
                            ...
                            <select name="pno" id="pno">
                                ...
                                <c:forEach var="deli" items="${deliveryList }" varStatus="status">
                                    <option value="${deli.dno }">배송 번호 ${deli.dno}</option>
                                </c:forEach>
                            </select>
                        </td>
                        <tr>
