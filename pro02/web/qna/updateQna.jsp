...
<div class="wrap">
    ...
    <div class="contents" id="contents">
        <div class="breadcrumb">
            <p><a href="/">HOME</a> &gt; <a href="/">QnA</a>
                &gt; <a href="/">QnA 수정</a></p>
        </div>
        <section class="page" id="page1">
            <div class="page_wrap">
                <h2 class="page_tit">QnA 수정</h2>
                <form action="${path}/UpdateQnaPro.do" class="frm" method="post">
                    <table class="tb1">
                        <tbody>
                        <tr>
                            <td colspan="2"><input type="text" name="title" id="title" class="indata" value="${qna.title}" placeholder="제목 입력" autofocus required></td>
                            <td><input type="hidden" name="qno" id="qno" value="${qna.qno}" readonly></td>
                            <td><input type="hidden" name="lev" id="lev" value="${qna.lev}" readonly></td>
                        </tr>
                        <tr>
                            <td colspan="2"> <textarea name="content" id="content" cols="50" rows="15" placeholder="내용 입력" required>${qna.title}</textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">
